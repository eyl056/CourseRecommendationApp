...
class Course1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button1.setOnClickListener {
            val intent = Intent(this, Course1DetailActivity::class.java)
            startActivity(intent)
        }
        var button2: Button = findViewById(R.id.button2)
        button2.setOnClickListener {
            val intent= Intent(this, Course1DetailActivity1::class.java)
            startActivity(intent)
        }
        var button3: Button = findViewById(R.id.button3)
        button3.setOnClickListener {
            val intent= Intent(this, Course1DetailActivity2::class.java)
            startActivity(intent)
        }
